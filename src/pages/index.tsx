...
const NuHome: NextPage = () => {
  ...
  return (
    <AnimatedLayout>
      <div className="h-full overflow-y-scroll bg-[url('../data/slanted-thumbs.webp')] bg-cover bg-no-repeat">
        <div className="h-full bg-green-50/60 dark:bg-black/80 transition-colors">
          <div className="h-full bg-gradient-to-tr dark:bg-gradient-to-tr from-transparent via-green-50/90 to-green-50 dark:via-black/90 dark:to-black transition-colors flex flex-col">
